--1. 춘 기술대학교의 학과 이름과 계열을 표시하시오. 단 출력 헤더는 "학과 명","계열"으로 표시하도록한다.
...
-- 그 대상자들의 학번이 다음과 같을 때 대상자들을 찾는 적적할 SQL 구문을 작성하시오
SELECT STUDENT_NAME
FROM TB_STUDENT
...
--그럼 춘 기술대학교 총장의 이름을 알아낼수 있는 SQL문장 작성
SELECT PROFESSOR_NAME
FROM TB_PROFESSOR
WHERE DEPARTMENT_NO IS NULL;

--7. 혹시 전산상의 착오로 학과가 지정되어 있지 않은 학생이 있는지 확인하고자한다.
...
-- 9. 춘 대학에는 어떤 계열(GATEGORY)들이 있는지 조회해보시오
SELECT CATEGORY
FROM TB_DEPARTMENT
GROUP BY CATEGORY;

--10. 02 학번 전주 거주자들의 모임을 만들려고 한다. 휴학한 사람들은 제외한
